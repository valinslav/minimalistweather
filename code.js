...
$.getJSON(`https://api.openweathermap.org/data/2.5/weather?q=${city}&APPID=c08f28491a3a2bbb6672e149c1e6342e&units=${tempType}`).done(callBack).fail(jsonFail);
...
function jsonFail(){
    if(localStorage.getItem("cityInSearchBar") == null && loadCount == 0){
